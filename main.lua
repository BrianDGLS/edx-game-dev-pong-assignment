...
function love.update(dt)
    ...
    -- player 2
    --[[
        Below is the code to add user input controls for player 2. This has been
        removed as player 2 will now be controlled by ai.    
    ...
    if ball.dx < 0 then
        ...
        if player2.y > centerY then
            player2.dy = -PADDLE_SPEED
        elseif player2.y < centerY then
            player2.dy = PADDLE_SPEED
        else
            player2.dy = 0
        end
